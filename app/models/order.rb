class Order
  ...
  attr_accessor :item_id, :user_id, :zip_code, :prefecture_id, :city, :address, :address2, :telephone
  ...
  with_options presence: true do
    ...
    validates :telephone, format: {with: /\A\d{11}\z/, message: "is invalid. Include hyphen(-)"}
  end
